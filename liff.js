...
const USER_SERVICE_UUID         = '48dc8e3e-4921-4816-82c1-74fbe03623a6'; // LED, Button
...
function initializeApp() {
    liff.init({liffId:"1660840207-yG2KP1Gj"},() => initializeLiff(), error => uiStatusError(makeErrorMsg(error), false));
}
